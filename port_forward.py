...
if __name__=='__main__':
    ...
    parser.add_argument('--remote-host', action="store", dest="remote_host",  default=HOST)
    ...
    print("Starting port forwarding local {!s}:{!s} => remote {!s}:{!s}".format(local_host, local_port, remote_host, remote_port))
